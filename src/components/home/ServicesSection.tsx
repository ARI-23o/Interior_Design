...
export const ServicesSection: React.FC<ServicesSectionProps> = ({ onSelectService, onOpenLeadModal }) => {
  return (
    <section id="services-section" className="py-24 bg-canvas">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {servicesData.map((service, index) => (
            <div
              key={service.id}
              className={`bg-canvas-soft border border-border-luxury p-8 flex flex-col justify-between luxury-card-hover group ${
            ...
            >
              <div>
                <div className="flex justify-between items-start gap-4 mb-4">
                  ...
                  <div className="flex items-center gap-1 text-[11px] text-charcoal-muted bg-canvas px-2.5 py-1 border border-border-luxury">
                    <Clock size={12} className="text-bronze" />
                    <span>{service.timeline}</span>
                  </div>
                </div>

                <h3 className="font-serif text-2xl sm:text-3xl text-charcoal group-hover:text-bronze-dark transition-colors mb-3">
                  {service.title}
                </h3>
                ...
                {/* Features list */}
                <div className="space-y-2.5 pt-4 border-t border-border-luxury/60">
              ...
              {/* Bottom Card Action */}
              <div className="pt-8 mt-6 border-t border-border-luxury/60 flex items-center justify-between">
