    ...
    <section className="py-24 bg-canvas border-t border-border-luxury">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-16 gap-6">
          ...
          <p className="text-charcoal-muted text-sm sm:text-base max-w-md font-light">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {whyChooseUsData.map((item) => (
            ...
            >
              <div>
                <div className="font-serif text-4xl text-bronze/60 font-light mb-6 group-hover:text-bronze transition-colors">
                  {item.number}
                </div>
                <h3 className="font-serif text-xl text-charcoal mb-3 group-hover:text-bronze-dark transition-colors">
                  {item.title}
                </h3>
              ...
              <div className="pt-6 mt-6 border-t border-border-luxury/60">
                <span className="text-[10px] uppercase tracking-widest text-charcoal-subtle">
                  Guaranteed Standard
                </span>
              </div>
            </div>
