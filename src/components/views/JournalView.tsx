  ...
  return (
    <div className="py-16 sm:py-24 bg-canvas min-h-screen">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {articlesData.map((art) => (
            ...
            >
              ...
              <div className="p-8 flex flex-col justify-between flex-grow space-y-4">
                <div>
                  <div className="flex items-center gap-3 text-xs text-charcoal-muted mb-2 font-light">
                  ...
                  <h2 className="font-serif text-2xl sm:text-3xl text-charcoal group-hover:text-bronze-dark transition-colors">
                    {art.title}
                  </h2>
        ...
        {selectedArticle && (
          <div className="fixed inset-0 z-50 overflow-y-auto bg-charcoal/80 backdrop-blur-md flex justify-center p-3 sm:p-6">
            <div className="bg-canvas w-full max-w-4xl my-auto border border-border-luxury shadow-luxury-lg overflow-hidden animate-in zoom-in-95 duration-200">
              ...
              <div className="sticky top-0 bg-canvas/95 backdrop-blur-md border-b border-border-luxury px-6 py-4 flex justify-between items-center z-10">
                <span className="text-xs uppercase tracking-widest text-bronze font-semibold">
                  {selectedArticle.category} · {selectedArticle.readTime}
                </span>
                <button
                  onClick={() => setSelectedArticle(null)}
                  className="p-1.5 text-charcoal hover:text-bronze"
                >
                  <X size={20} />
                </button>
              </div>
              ...
              <div className="p-6 sm:p-12 space-y-8 max-h-[80vh] overflow-y-auto">
                ...
                <div className="space-y-6 text-charcoal font-light leading-relaxed text-sm sm:text-base">
                  ...
                  <div className="bg-canvas-soft p-6 border-l-4 border-bronze text-sm text-charcoal space-y-1 mt-6">
                ...
                <div className="bg-charcoal text-canvas p-8 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                  <div>
                    <h4 className="font-serif text-xl">Need a tailored estimate for your home?</h4>
                  ...
                  <button
                    ...
                    className="bg-bronze text-charcoal font-semibold text-xs uppercase tracking-widest px-6 py-3 shrink-0"
                  >
                    Request Estimate →
                  </button>
                </div>
